...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Nov 2019 pada 14.02
...
INSERT INTO `product` (`id`, `name`, `price`, `id_categori`, `id_cashier`) VALUES
(1, 'Late', 10000, 2, 1),
(2, 'Cake', 20000, 1, 2),
...
ALTER TABLE `product`
  ...
  ADD CONSTRAINT `product_ibfk_2` FOREIGN KEY (`id_categori`) REFERENCES `category` (`id`);
COMMIT;
